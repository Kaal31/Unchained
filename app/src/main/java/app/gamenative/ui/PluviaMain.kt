...
fun PluviaMain(
    ...
    // Update check disabled: this is a standalone fork with its own package, so the
    // upstream GameNative update feed must never offer/install the stock APK over it.
                ...
                composable(
                    ...
                    LaunchedEffect(Unit) {
                        ...
                        if (shouldShowDialogs && !state.annoyingDialogShown && PluviaApp.xEnvironment == null && !SteamService.keepAlive && !MainActivity.wasLaunchedViaExternalIntent) {
                            ...
                            // Startup support/"thank you" notification removed.
                        }
                    }

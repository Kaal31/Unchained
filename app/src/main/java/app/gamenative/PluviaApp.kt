...
class PluviaApp : SplitCompatApplication() {
    ...
    override fun onCreate() {
        ...
        app.gamenative.luatools.LuaToolsPrefs.init(this)
        app.gamenative.luatools.DenuvoRepository.init(this)
        ...
        // Usage analytics removed: PostHog is never initialized, so any capture()
        // calls elsewhere are inert no-ops and no data is collected.
